...
export class SearchBooksComponent implements OnInit {
  ...
  cargarLectores() {
    this.http.get<any>('https://biblioteca-aobw.onrender.com/lector').subscribe(
      (data) => {
        this.lectores = data;
  ...
  cargarAutoresYEditoriales() {
    this.http.get<any>('https://biblioteca-aobw.onrender.com/api/libros/autores-editoriales').subscribe(
      (data) => {
  ...
  submitLoanForm() {
    ...
    this.http.get(`https://biblioteca-aobw.onrender.com/lector/${this.numeroControl}`).subscribe(
        (lector: any) => {
            ...
            this.http.post('https://biblioteca-aobw.onrender.com/loanBook', loanData).subscribe(
                (response: any) => {
                    ...
                    this.http.put(`https://biblioteca-aobw.onrender.com/updateBook/quantity/${this.selectedBook.ISBN}`, updateData).subscribe(
                        (updateResponse) => {
